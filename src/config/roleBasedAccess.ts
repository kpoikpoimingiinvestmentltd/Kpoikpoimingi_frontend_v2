 ...
 * 4. Users - ADMIN and SUPER_ADMIN
 * 5. Debt - ADMIN and SUPER_ADMIN
 * 6. Report and Analytics - ADMIN and SUPER_ADMIN
 * 7. STAFF cannot delete, export, send emails, terminate contracts, or decline requests
 */
...
export const ROLE_BASED_ACCESS = {
	...
	notifications: ["STAFF", "ADMIN", "SUPER_ADMIN"],
};
