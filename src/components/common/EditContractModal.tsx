...
export default function EditContractModal({
    ...
    if (contract && isOpen) {
      ...
      setFormData({
        ...
        durationValue: contract.durationValue
          ? String(contract.durationValue)
          : "",
        durationUnitId: contract.durationUnitId
          ? String(contract.durationUnitId)
          : "",
        paymentMethod: "link",
      });
    }
  ...
  const updateMutation = useUpdateContract(
    (response) => {
      ...
      const downPaymentLink = (response as { downPaymentLink?: string })
        ?.downPaymentLink;
      if (downPaymentLink) {
    ...
    try {
      ...
      if (isHirePurchase) {
        ...
        if (formData.durationValue)
          payload.durationValue = formData.durationValue;
        if (formData.durationUnitId)
          payload.durationUnitId = formData.durationUnitId;
      } else {
                ...
                <>
                  ...
                  <div className="w-full">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange("intervalId", value)
                      }
                    >
                  ...
                  <div className="w-full">
                    ...
                    <Select
                      value={formData.durationUnitId}
                      onValueChange={(value) =>
                        handleSelectChange("durationUnitId", value)
                      }
                    >
                      <SelectTrigger className={selectTriggerStyle()}>
                  ...
                  <div className="w-full">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange("durationValue", value)
                      }
                    >
                      <SelectTrigger className={selectTriggerStyle()}>
                      ...
                      <SelectContent>
                        {(() => {
                          ...
                          const maxWeekly = 260;
                          const maxMonthly = 60;
                          const max = isWeekly ? maxWeekly : maxMonthly;
                          return Array.from(
                            { length: max },
                            (_, i) => i + 1,
                          ).map((n) => (
